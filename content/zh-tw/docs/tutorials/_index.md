...
* [使用 ConfigMap 設定 Redis](/zh-tw/docs/tutorials/configuration/configure-redis-using-configmap/)
...
* [採用 Sidecar 容器](/zh-tw/docs/tutorials/configuration/pod-sidecar-containers/)
...
* [對外公開 IP 位址以存取叢集中的應用程式](/zh-tw/docs/tutorials/stateless-application/expose-external-ip-address/)
* [範例：使用 Redis 部署 PHP 留言板應用程式](/zh-tw/docs/tutorials/stateless-application/guestbook/)
...
* [StatefulSet 基礎](/zh-tw/docs/tutorials/stateful-application/basic-stateful-set/)
* [範例：使用持久卷部署 WordPress 與 MySQL](/zh-tw/docs/tutorials/stateful-application/mysql-wordpress-persistent-volume/)
* [範例：使用 StatefulSet 部署 Cassandra](/zh-tw/docs/tutorials/stateful-application/cassandra/)
* [執行 ZooKeeper（CP 分散式系統）](/zh-tw/docs/tutorials/stateful-application/zookeeper/)
...
* [使用 Service 連接應用程式](/zh-tw/docs/tutorials/services/connect-applications-service/)
* [使用來源 IP](/zh-tw/docs/tutorials/services/source-ip/)
...
* [在叢集層級套用 Pod 安全標準](/zh-tw/docs/tutorials/security/cluster-level-pss/)
* [在命名空間層級套用 Pod 安全標準](/zh-tw/docs/tutorials/security/ns-level-pss/)
* [使用 AppArmor 限制容器對資源的存取](/zh-tw/docs/tutorials/security/apparmor/)
* [Seccomp](/zh-tw/docs/tutorials/security/seccomp/)
...
如果您想撰寫教學，請參閱
[內容頁面類型](/zh-tw/docs/contribute/style/page-content-types/)
以取得有關教學頁面類型的資訊。
